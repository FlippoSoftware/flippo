...
> & {
     ...
     * Receives the highlighted item value (or `undefined` if no item is highlighted) and event details with a
     * `reason` property describing why the highlight changed.
     * The `reason` can be:
