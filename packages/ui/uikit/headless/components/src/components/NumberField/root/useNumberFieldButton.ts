...
import type { Direction, EventWithOptionalKeyState, IncrementValueParameters } from '../utils/types';
...
export type UseNumberFieldButtonParameters = {
...
export type UseNumberFieldButtonReturnValue = {
    props: HTMLProps;
};
