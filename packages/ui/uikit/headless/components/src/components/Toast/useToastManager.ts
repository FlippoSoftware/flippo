...
export namespace useToastManager {
    ...
    export type AddOptions<Data extends object> = {
        id?: string;
    } & Omit<ToastObject<Data>, 'id' | 'animation' | 'height' | 'ref' | 'limited'>;

    export type UpdateOptions<Data extends object> = {} & Partial<AddOptions<Data>>;

    export type PromiseOptions<Value, Data extends object> = {
...
export type ToastObject<Data extends object> = {
    /**
