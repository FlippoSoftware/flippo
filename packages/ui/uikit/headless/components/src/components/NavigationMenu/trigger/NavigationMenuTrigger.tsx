...
import { useAnimationFrame, useIsoLayoutEffect, useTimeout } from '@flippo-ui/hooks';
...
import { EMPTY_ARRAY, ownerVisuallyHidden, PATIENT_CLICK_THRESHOLD } from '~@lib/constants';
import { createChangeEventDetails } from '~@lib/createHeadlessUIEventDetails';
import { FocusGuard } from '~@lib/FocusGuard';
import { getCssDimensions } from '~@lib/getCssDimensions';
 ...
 */
export function NavigationMenuTrigger(componentProps: NavigationMenuTriggerProps) {
    const {
        className,
        render,
        nativeButton = true,
    ...
    return (
        <React.Fragment>
            <CompositeItem
              ...
              refs={[ref, setTriggerElement, buttonRef]}
              props={[
                    getReferenceProps,
...
export type NavigationMenuTriggerProps = {} & NativeButtonProps & HeadlessUIComponentProps<'button', NavigationMenuTrigger.State>;
