...
import { hide } from '~@lib/hideMiddleware';
import {
    autoUpdate,
    flip,
    limitShift,
...
import type { FloatingTreeStore } from '~@packages/floating-ui-react/components/FloatingTreeStore';
...
export type UseAnchorPositioningSharedParameters = {
    /**
...
export type UseAnchorPositioningParameters = {
    keepMounted?: boolean;
...
export type UseAnchorPositioningReturnValue = {
