...
const preamble = ['// This file is autogenerated. Do not edit it directly.', '// To update it, modify the corresponding source file and run `pnpm inline-scripts`.'].join('\n');
...
async function buildFile(sourceFile: string) {
    ...
    const output = [preamble, '', '// prettier-ignore', `export const script = '${escapedCode}';\n`].join('\n');
