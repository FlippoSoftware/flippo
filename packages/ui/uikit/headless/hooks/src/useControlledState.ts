...
type TChangeHandler<T> = (state: T)=> void;
...
export function useControlledState<T>(params: TUseControlledStateParams<T>) {
  ...
  }, [state, isControlled, setUncontrolledSet, onChangeRef]);
